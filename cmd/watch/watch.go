...
func init() {
	...
	WatchCmd.Flags().String("output-dir", "", "Output directory for generated packs")
	WatchCmd.Flags().String("output-type", "", "Output type {packdir|archive}")
	...
	viper.BindPFlag("output_type", WatchCmd.Flags().Lookup("output-type"))
}
